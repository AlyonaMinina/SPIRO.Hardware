...
SPIRO comprises six sets of 3D printable structural parts. Sets 3a and 3b are for alternative setups that include either ArduCam IMX219 or raspberry pi v2 camera, respectively.
...
g. one corner for mounting vertical rail<br />
...
Set 2 should be printed without brim or any supports. Removing supports will be an outstandingly unpleasant task, I cut up myself real bad with the screwdriver. <br />
For structural purposes 20% infill and draft quality (0.35 mm thickness of vertical layers) is sufficient. <br />
...
d. set 3a also includes an extra support for the raspberry pi v2 camera to prevent it from tilting during manual focusing<br />
<br />
